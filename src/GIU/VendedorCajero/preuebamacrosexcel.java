...
private void toggleMenu() {
    ...
    private void initComponents() {
        ...
        btn_apertura_de_caja.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_apertura_de_cajaMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
        ...
        btn_consultar_venta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_consultar_ventaMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
 ...
 btn_consultar_venta.setBackground(new Color(17,141,192));
    ...
    private void btn_apertura_de_cajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_apertura_de_cajaMouseClicked
        // TODO add your handling code here:
        cambiarPanel("Panel 3");
    }//GEN-LAST:event_btn_apertura_de_cajaMouseClicked

    private void btn_consultar_ventaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_consultar_ventaMouseClicked
        // TODO add your handling code here:

...
public class PanelVendedorprincipalmenuslidinperfectbase extends javax.swing.JFrame {
...
//    vendedor_menu_pop_1 pop_vendedor_menu=new vendedor_menu_pop_1();
    ...
    public PanelVendedorprincipalmenuslidinperfectbase() {
        initComponents();
...
//Esta clase es para que la consulta se haga en un hilo diferente y se actualicen los textFields sin retraso en la interface de usuario
   private class ConsultarDniWorker extends SwingWorker<Void, Void> {
    ...
    private void initComponents() {
        ...
        Opciones.setPreferredSize(new java.awt.Dimension(282, 700));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 690, 480));
 ...
 btn_consultar_venta.setBackground(new Color(17,141,192));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelVendedorprincipalmenuslidinperfectbase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelVendedorprincipalmenuslidinperfectbase().setVisible(true);
            }
        });
    }

...
public class PanelVendedorPrincipalbaseslidinperfectversion2 extends javax.swing.JFrame {
    private Timer slideTimer;
    private boolean isMenuVisible=true;
    private int panelWidth=282;
...
//    vendedor_menu_pop_1 pop_vendedor_menu=new vendedor_menu_pop_1();
    ...
    public PanelVendedorPrincipalbaseslidinperfectversion2() {
        initComponents();
       // Opciones.setBounds(-panelWidth, 0, panelWidth, getHeight());
    }
    
  private void toggleMenu() {
    if (slideTimer != null && slideTimer.isRunning()) {
        return; // No iniciar un nuevo timer si ya hay uno en ejecución
    }
    ...
    slideTimer = new Timer(5, new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Opciones.setBounds(currentPos, 0, panelWidth, getHeight());
        }
    });
...
//Esta clase es para que la consulta se haga en un hilo diferente y se actualicen los textFields sin retraso en la interface de usuario
   private class ConsultarDniWorker extends SwingWorker<Void, Void> {
    ...
    private void initComponents() {
        ...
        Opciones.setPreferredSize(new java.awt.Dimension(282, 660));
        ...
        Opciones.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, -1, -1));
        ...
        Opciones.add(btn_flujo_de_caja, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, -1));
        ...
        Opciones.add(btn_apertura_de_caja, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, -1, -1));
        ...
        Opciones.add(btn_realizar_cierre_de_caja, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, -1, -1));
        ...
        Opciones.add(btn_crear_nueva_venta, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, -1, -1));
        ...
        Opciones.add(btn_consultar_venta, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, -1, -1));

        jLabel14.setFont(new java.awt.Font("Source Code Pro Black", 0, 16)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("Lucía Farfán");
        Opciones.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 250, -1));

        jSeparator3.setForeground(new java.awt.Color(255, 255, 255));
        jSeparator3.setPreferredSize(new java.awt.Dimension(260, 3));
        Opciones.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 262, -1, -1));

        jPanel1.add(Opciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, -1, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(282, 40, -1, -1));
 ...
 btn_consultar_venta.setBackground(new Color(17,141,192));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelVendedorPrincipalbaseslidinperfectversion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelVendedorPrincipalbaseslidinperfectversion2().setVisible(true);
            }
        });
    }

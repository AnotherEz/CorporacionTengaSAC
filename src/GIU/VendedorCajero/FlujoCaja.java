...
public class FlujoCaja extends javax.swing.JFrame {
 ...
 btn_consultar_venta.setBackground(new Color(17,141,192));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FlujoCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
